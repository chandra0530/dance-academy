                                                ...
                                                <form action="">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 col-12 mb-1">
                                                            ...
                                                            <div class="input-group">
                                                                <select class="select2 form-select" id="select2-student" name="select_student">
                                                                      
                                                                <option value="all" {{ $selectedlocation=='all'?'selected':''}}>Select Student</option>
