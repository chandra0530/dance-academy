                                                            ...
                                                            <select class="select2 form-select" id="select2-product"
                                                                ...
                                                                @foreach ($batchlist as $batch)
                                                                    <option value="{{ $batch->id }}"
                                                                        {{ $userdetails->batch_id == $batch->id ? 'selected' : '' }}>
                                                                        {{ $batch->location?$batch->location->location_name:'' }}{{ $batch->batch_name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    ...
                                                    <fieldset class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="email" id="email"
                                                                placeholder="Enter email" value="{{ $userdetails->email }}">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                    ...
                                                    <fieldset class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="phone" id="phone"
                                                                placeholder="Enter phone" value="{{ $userdetails->phone }}">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                <div class="col-sm-6 col-12">
